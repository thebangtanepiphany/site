        ...
        <div className="card-deck">
          <div className="card">
            ...
            <div className="card-body">
              <p className="card-text">Emily is a unpublished writer, parttime painter and fulltime ARMY circa March 9, 2019 <span role="img" aria-label="winking face">&#128521;</span>. She loves to talk about culture, art, music... really just about anything. She may or may not be an immortal vampire.</p>
            </div>
          </div>
          <div className="card">
