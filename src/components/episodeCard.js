...
export default function EpisodeCard(props) {
  ...
  const image = num >= 39 && num <= 46 ? `/ep${num}.gif` : 'apple-icon.png'
  return (
    <div
      style={rotate}
      ...
      <div className={styles.episode}>
        <a href="https://podcasts.google.com/feed/aHR0cHM6Ly9mZWVkcy5idXp6c3Byb3V0LmNvbS84MTQ4MDEucnNz" className={styles.link} target="_blank" rel="noopener noreferrer">
        ...
        <a href="https://open.spotify.com/show/2wglhSf4DW5RHFCUD3dbx5" className={styles.link} target="_blank" rel="noopener noreferrer">
        ...
        <a href="https://podcasts.apple.com/us/podcast/the-bangtan-epiphany-a-bts-podcast/id1495749770" className={styles.link} target="_blank" rel="noopener noreferrer">
